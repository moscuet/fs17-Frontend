...
import { Container, Grid, Card, CardContent, CardMedia, Typography, Button, Drawer, List, ListItem, ListItemText, FormControl, InputLabel, Select, MenuItem, Slider, Box, SelectChangeEvent } from '@mui/material';
...
const ProductLinesPage: React.FC = () => {
    ...
    const handleCategoryChange = (event: SelectChangeEvent<string | null>, child: ReactNode) => {
    ...
    const handleSortChange = (event: SelectChangeEvent<string | null>, child: ReactNode) => {
